...
ggsave("graph_linear_regression_jyske_asyl_development_treatment_results_1878-1945.png", 
...
# Saving the graph as a png file
ggsave("graph_jyske_asyl_development_treatment_results_1878-1945.png", 
       width = 20, height = 7, path = "figures")
...
# Saving the graph as a png file
ggsave("graph_jyske_asyl_development_remaining_outgoing_1878-1945.png", 
       width = 20, height = 7, path = "figures")
